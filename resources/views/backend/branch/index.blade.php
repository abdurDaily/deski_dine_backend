...
@push('styles')
    ...
    <style>
        ...
        .branch-datatable td {
            ...
            max-width: 200px; /* Limits width to trigger wrapping */
        }
...
<script>
    $(document).ready(function() {
        ...
        const table = $('.branch-datatable').DataTable({
            ...
            columnDefs: [
                { className: "desktop", "targets": [ 1, 2, 3 ] }, // Priority columns
        ...
        $('#branchForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                beforeSend: function() { $('#submitBtn').prop('disabled', true).text('Processing...'); },
                ...
                complete: function() { $('#submitBtn').prop('disabled', false).text('Save Branch'); }
            });
        });
